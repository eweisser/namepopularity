...
smallDictio = {}    
byNameDictio = {}
allBirthsDictio = {'AL':40516,'AK':1800,'AZ':10168,'AR':22313,'CA':118974,'CO':16306,'CT':19829,'DE':3742,'FL':31498,'GA':44907,'HI':6921,'ID':7902,'IL':92426,'IN':45506,'IA':30382,'KS':21165,'KY':36402,'LA':37502,'ME':10310,'MD':26384,'MA':46536,'MI':78439,'MN':36508,'MS':31679,'MO':42007,'MT':7604,'NE':15345,'NV':1752,'NH':5613,'NJ':47455,'NM':10855,'NY':146714,'NC':52014,'ND':8386,'OH':90248,'OK':24358,'OR':17527,'PA':107876,'RI':7869,'SC':28140,'SD':8618,'TN':39574,'TX':99366,'UT':10304,'VT':4390,'VA':39864,'WA':27135,'WV':24585,'WI':40134,'WY':3751}
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                ...
                if row[1] == "F" and row[2] == "1950" and not row[0] == "DC":
...
fileToWrite = open("gimpCode/gimpCode1950F.txt", "w")
