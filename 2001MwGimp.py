...
# ! Notes for 2001-M:
# Writing to a .txt file went successfully. This will be the first version to incorporate the 100 top names ranked list and automatically run them, sending the code to a .txt file.

# If the dictionary 'allBirthsDictio' starts with a value of 30915 for Alabama, you still have the values from 2001/males. If this is supposed to be a different file, some or all values will need to be changed.
...
smallDictio = {}    
byNameDictio = {}
allBirthsDictio = {'AL':30915,'AK':5142,'AZ':43544,'AR':18969,'CA':269461,'CO':34328,'CT':21840,'DE':5477,'FL':105295,'GA':67855,'HI': 8660,'ID':10451,'IL':94157,'IN':44330,'IA':19225,'KS':19895,'KY':27938,'LA':33609,'ME':7133,'MD':37322,'MA':41185,'MI':68771,'MN':34572,'MS':21519 ,'MO':38447,'MT':5582,'NE':12568,'NV':16039,'NH':7393,'NJ':59368,'NM':13808,'NY':130026,'NC':60202,'ND':3811,'OH':77557,'OK':25619,'OR':23174,'PA':73401,'RI':6488,'SC':28563,'SD':5245,'TN':40334,'TX':186928,'UT':24659,'VT':3223,'VA':50650,'WA':40640,'WV':10461,'WI':35089,'WY':3183}
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                ...
                if row[1] == "M" and row[2] == "2001" and not row[0] == "DC":
...
fileToWrite = open("gimpCode/gimpCode2001M.txt", "w")
