...
# ! Notes for 2000-M:
# Writing the GIMP code for the top 100 names to a .txt file went mostly successfully. Just remember to have the right filename to write to in this code! I don't have any changes in mind for this file, so it will be a copy of 2001-M, except with relevant values changed, of course.
...
smallDictio = {}    
byNameDictio = {}
allBirthsDictio = {'AL':32330,'AK':5154,'AZ':43593,'AR':19324,'CA':272409,'CO':33481,'CT':22120,'DE':5730,'FL':104162,'GA':67537,'HI':9139,'ID':10400,'IL':94303,'IN':45108,'IA':19489,'KS':20382,'KY':28884,'LA':34472,'ME':6977,'MD':37916,'MA':41762,'MI':69563,'MN':34611,'MS':22575,'MO':39085,'MT':5582,'NE':12614,'NV':15976,'NH':7635,'NJ':59228,'NM':13889,'NY':132715,'NC':61320,'ND':3994,'OH':79650,'OK':25638,'OR':23516,'PA':74678,'RI':6534,'SC':28725,'SD':5327,'TN':40732,'TX':185619,'UT':24370,'VT':3359,'VA':50494,'WA':41580,'WV':10754,'WI':35454,'WY':3147}
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                ...
                if row[1] == "M" and row[2] == "2000" and not row[0] == "DC":
...
fileToWrite = open("gimpCode/gimpCode2000M.txt", "w")
