...
smallDictio = {}    
byNameDictio = {}
allBirthsDictio = {'AL':42100,'AK':1925,'AZ':10655,'AR':23279,'CA':125897,'CO':17579,'CT':20791,'DE':3901,'FL':33146,'GA':46505,'HI':7133,'ID':8133,'IL':97487,'IN':47973,'IA':32278,'KS':22763,'KY':38624,'LA':38860,'ME':10751,'MD':27821,'MA':49678,'MI':82516,'MN':38809,'MS':33225,'MO':43917,'MT':8007,'NE':16454,'NV':1915,'NH':5904,'NJ':50347,'NM':11237,'NY':154329,'NC':54472,'ND':8644,'OH':95602,'OK':25762,'OR':18552,'PA':113759,'RI':8341,'SC':29310,'SD':9188,'TN':41802,'TX':104475,'UT':10888,'VT':4613,'VA':42157,'WA':28682,'WV':25922,'WI':42540,'WY':3855}
# Alaska data from: https://www.cdc.gov/nchs/data/vsus/vsus_1950_1.pdf, pp. 275/285
# Hawaii data from: https://www.cdc.gov/nchs/data/vsus/vsus_1950_1.pdf, pp. 296/306
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                ...
                if row[1] == "M" and row[2] == "1950" and not row[0] == "DC":
...
fileToWrite = open("gimpCode/gimpCode1950M.txt", "w")
