...
smallDictio = {}    
byNameDictio = {}
allBirthsDictio = {'AL':28941,'AK':5862,'AR':16827,'AZ':29799,'CA':235632,'CO':27009,'CT':21822,'DE':4796,'FL':81590,'GA':47743,'HI': 8889,'ID':8036,'IL':86298,'IN':38809,'IA':18905,'KS':19029,'KY':25118,'LA':37943,'ME':8098,'MD':33945,'MA':40091,'MI':67017,'MN':32149,'MS':20267 ,'MO':36523,'MT':6058,'NE':11915,'NV':7737,'NH':7790,'NJ':53052,'NM':13452,'NY':128800,'NC':43849,'ND':5280,'OH':77004,'OK':24490,'OR':18950,'PA':78178,'RI':6577,'SC':25339,'SD':5779,'TN':32403,'TX':149668,'UT':17739,'VT':4029,'VA':42838,'WA':33896,'WV':11255,'WI':35192,'WY':4220}
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                if row[1] == "F" and row[2] == "1986" and not row[0] == "DC":
