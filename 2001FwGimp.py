...
# ! Notes for 2001-F:
# This is being started after I completed 1986 (M and F) and 2002 (M and F). The latest two features added to those were automatic gray coloring for states with n/a data, and the 'state' command in the prompt to show a state's residual standard deviation proportions.
# This will be the first version to write to a .txt file.
...
smallDictio = {}    
byNameDictio = {}
allBirthsDictio = {'AL':29539,'AK':4861,'AR':18041,'AZ':42053,'CA':258298,'CO':32679,'CT':20808,'DE':5272,'FL':100498,'GA':65671,'HI': 8412,'ID':10237,'IL':89907,'IN':42129,'IA':18394,'KS':18974,'KY':26720,'LA':31743,'ME':6626,'MD':35896,'MA':39892,'MI':64656,'MN':32990,'MS':20763 ,'MO':37017,'MT':5388,'NE':12252,'NV':15343,'NH':7263,'NJ':56427,'NM':13320,'NY':124000,'NC':57983,'ND':3818,'OH':74013,'OK':24499,'OR':22148,'PA':70094,'RI':6225,'SC':27193,'SD':5238,'TN':38006,'TX':178482,'UT':23300,'VT':3143,'VA':48234,'WA':38930,'WV':9967,'WI':33983,'WY':2932}
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                if row[1] == "F" and row[2] == "2001" and not row[0] == "DC":
...
fileToWrite = open("gimpCode/gimpCode2001F.txt", "w")
