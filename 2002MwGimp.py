...
smallDictio = {}
byNameDictio = {}
allBirthsDictio = {'AL':29969,'AK':5048,'AZ':45100,'AR':19178,'CA':270435,'CO':35195,'CT':21578,'DE':5693,'FL':105352,'GA':68028,'HI':9188,'ID':10693,'IL':92468,'IN':43369,'IA':19362,'KS':20099,'KY':27898,'LA':33243,'ME':6919,'MD':37599,'MA':41234,'MI':66476,'MN':34844,'MS':21275,'MO':38720,'MT':5621,'NE':12967,'NV':16691,'NH':7490,'NJ':58970,'NM':13963,'NY':128756,'NC':60041,'ND':4046,'OH':76239,'OK':25907,'OR':23095,'PA':73134,'RI':6618,'SC':27845,'SD':5511,'TN':39404,'TX':190201,'UT':25165,'VT':3279,'VA':50722,'WA':40471,'WV':10691,'WI':35019,'WY':3375}
residualsDictio = {}
resStDevPercDictio = {}
red4 = []
red3 = []
    ...
    if entry.name.endswith('.TXT'):     # consider only the .txt files
        with open(entry.name) as csv_file:      # let's open that .txt file as a CSV file
            ...
            for row in csv_reader:          # take a row, and--
                if row[1] == "M" and row[2] == "2002" and not row[0] == "DC":
                    row[4] = int(row[4])/allBirthsDictio[row[0]]   # turn the raw number into the proportion of babies with that name
                    allData.append(row)
